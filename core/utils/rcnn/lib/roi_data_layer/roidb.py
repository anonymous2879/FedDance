...
#import sys             我加的东西都屏蔽了，变成原始的了
#sys.path.append('\\home\\yhchen\\CYH\\core\\utils\\rcnn\\lib')  #上面这两句是我加的，处理重名
#from .. import datasets as da
#logging.info(f'Storing partitioning to file {da.__file__}')
#print(da.__file__)
#from da import factory
#from da.factory import get_imdb

#import sys
# 添加包的绝对路径到 sys.path
#sys.path.insert(0, '/home/yhchen/CYH/core/utils/rcnn/lib/datasets')


#from lib.datasets import factory
#from factory import get_imdb

import datasets       #这是原始的，会重名
import numpy as np
