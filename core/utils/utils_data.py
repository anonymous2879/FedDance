...
def get_data_transform(data: str):
    #- Reproducability - set the transform seed - does not work
    #random.seed(0)
...
#        test_transform = transforms.Compose([transforms.Resize(256), transforms.RandomResizedCrop(224), transforms.ToTensor(), normalize,])
