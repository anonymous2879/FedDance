...
class Client(object):                                                  
    ...
    def __init__(self, hostId, clientId, speed, traces=None):
        ...
        #- based on the format from the device trace file key:432802 val:{'computation': 162.0, 'communication': 5648.109619499134}
    ...
    #- the trace pickle file contains only 107,749 clients!
    ...
    #- return the availability windows of the client
    ...
    #- the trace pickle file contains only 500,000 clients!
