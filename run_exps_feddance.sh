...
# export DATA_PATH=/home/FedDance/dataset/data/${dataset}  
export DATA_PATH=/home/FedDance/dataset/data/    
...
tags="FedDance" #"r-safa" #"badstale" #"avail" #"central" #"motive2" "motive1" #"safa1" #"avail" #"stale" # #"avail" #"safa" "r-safa"  "delta"
...
#the data partitioning method: -1 IID-uniform, 0 Fedscale mapping, 1 NONIID-Uniform, 2 NONIID-Zipfian, 3 NONIID-Balanced, 6-Dirichlet
partitions="6" #"-1 0 1 2 3"                                     
...
#We adjust the SAFA experiments as they are extermely expensive to run, all online clients are invoked in each round!    单独调整SAFA的参数
